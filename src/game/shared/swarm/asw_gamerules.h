...
public:
	...
	enum WeaponTypes 
	{
		...
		BULLET_STORM,	// allowed rifles, autogun, shotgun, sniper, pdw, sentries, medgun
	...
	int	   m_iPrespawnScale;  // the factor used to scale the amount of prespawned aliens
	...
	int	   m_iDifficultyScale; // If 1 increases difficulty
